...
from .core.pc_config import apply_pc_hbm_defaults, pc_hbm_enabled
from .memory.pc_memory import PCHBMMemory

def build_pc_hbm(*args, **kwargs):
    """Lazy factory to avoid import cycles with models.build_model."""

    from .core.engine import build_pc_hbm as _build_pc_hbm
...
def __getattr__(name):
    if name == "PCHBMEngine":
        from .core.engine import PCHBMEngine
