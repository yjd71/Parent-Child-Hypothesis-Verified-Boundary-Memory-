...
vis_sam_refine_max_samples = 6
sam_refine_vis_dir = ckpt_dir.rstrip("/\\") + "/finetune_27_sv_ume_svb_plr_visualization"
...
# wandb metadata
ModelName = "PrototypeNet_Finetune27_SV_UME_SVB_PLR_Full"
others = {
...
# python -m scripts.train --config config/runs/finetune_27_sv_ume_svb_plr_full.py
