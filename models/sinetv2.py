...
from models.backbones.res2net_v1b import res2net50_v1b_26w_4s
...
class SINet_v2(nn.Module):
    # res2net based encoder decoder
    def __init__(self, config, channel=32, imagenet_pretrained=True):
        super(SINet_v2, self).__init__()
        self.config = config
        # ---- ResNet Backbone ----
        self.resnet = res2net50_v1b_26w_4s(pretrained=imagenet_pretrained)
        # disable grad for fc layer
        self.resnet.fc.bias.requires_grad = False
        self.resnet.fc.weight.requires_grad = False
...
if __name__ == '__main__':
    ...
    net = SINet_v2(imagenet_pretrained=False)
    net.eval()
